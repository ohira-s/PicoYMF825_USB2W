...
![PICO YMF825 Overview](https://github.com/ohira-s/PicoGuitarDrum2Web/blob/master/Docs/pico_ymf825_overview.jpg)
## 1. 機能
...
### 7-5. SUSR: R4
	ロータリーエンコーダーR4を回して値を選択します。  
	オペーターエンベロープのサスティーンリリース時間を変更します。  
